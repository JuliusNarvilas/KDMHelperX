...
namespace Common
{
    ...
    public static class Log
    {
        ...
        private static void DefaultAssertFunc(bool i_Assert, string i_Message, params object[] i_Args)
        {
            ...
            if(!i_Assert)
            {
                string finalMessage = string.Format("ASSERT: " + i_Message, i_Args);
        ...
        private static void DefaultLogFunc(string i_Message, params object[] i_Args)
        {
            Console.WriteLine(i_Message, i_Args);
        }
        private static void DefaultWarningFunc(string i_Message, params object[] i_Args)
        {
            Console.WriteLine("WARNING: " + i_Message, i_Args);
        }
        private static void DefaultErrorFunc(string i_Message, params object[] i_Args)
        {
            string finalMessage = string.Format("ERROR: " + i_Message, i_Args);
            Console.WriteLine(finalMessage);
            throw new Exception(finalMessage);
        }
        ...
        private static readonly LogStream Default = new LogStream(
            ...
            DefaultLogFunc, DefaultWarningFunc, DefaultErrorFunc, DefaultAssertFunc
        );
